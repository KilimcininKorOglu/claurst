...
//!
//! Disable with `MIKMIK_NO_HYPERLINKS=1`.
...
fn enabled() -> bool {
    enabled_for(std::env::var("MIKMIK_NO_HYPERLINKS").ok().as_deref())
}
...
mod tests {
    ...
    fn handles_share_url_with_hash_fragment() {
        let url =
            "https://kilimcininkoroglu.github.io/claurst/session/#c2cc4dd0ae0d3fa6dc7ab21f2a79d7a1";
